    ...
    <div className="container-xxl">
      <div className="row justify-content-center justify-content-md-start">
        <div className="col-md-4 col-lg-4 mb-4 mb-md-0 ">
          ...
          <div className='mb-3'><p><b>Phone:</b>Call us at +021 32423051</p> </div>
          ...
          <Link><BsTwitter className='fs-4' /></Link>
        ...
        <div className="col-md-4 col-lg-4">
          ...
          <div className='mb-3'>
          <Link><img src={playstore} alt="" /></Link>
          </div>
          <div className='mb-3'>
          <Link>
      ...
      <div className="row">
        ...
        <p className="text-center text-md-start">&copy;All Rights Reserved</p>
        </div>
        <div className="col-12 col-md-6">
